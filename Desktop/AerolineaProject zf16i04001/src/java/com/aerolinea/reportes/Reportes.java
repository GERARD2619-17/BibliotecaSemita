...
public class Reportes extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        File reportFile = new File(context.getRealPath("/")+"reportes/newReport.jasper");
        //configuramos los parametros en una varible de tipo Map
        //que como un array
        Map parameters = new HashMap();
        parameters.put("idorigen", Integer.parseInt(request.getParameter("idorigen")));
