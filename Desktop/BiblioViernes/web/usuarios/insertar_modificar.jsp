...
<form name="form_usuarios" onsubmit="return validar();" action="${pageContext.servletContext.contextPath}/Usuarios?accion=insertar_modificar" method="POST">
    ...
    <tbody>
        ...
        <tr>
            <td>Email </td>
            <td><input type="text" maxlength="40" size="30" placeholder="Escribe tu correo" required autofocus name="txtEmail" id="txtEmail" value="${usuario.email}" onKeyUp="javascript:validateMail('txtEmail')" title="Ingrese una direccion de correo valida" /></td>
        </tr>  
        <tr>
            <td>Telefono </td>
        ...
        <tr>
            <td>Clave </td>
            <td><input type="password" minlength="5" maxlength="20" size="30" placeholder="Escribe tu clave" required autofocus title="Tamaño mínimo: 5. Tamaño máximo: 20" name="txtClave" id="txtClave" value="${usuario.clave}" />
                <label>
