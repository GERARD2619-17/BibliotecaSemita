...
<form name="main" method="post" action="${pageContext.servletContext.contextPath}/Prestamos">
    ...
    <input type="button" class="boton" value="..." onclick="abrirVentana('${pageContext.servletContext.contextPath}/Prestamos?accion=listado_origen');">
    <a href="${pageContext.servletContext.contextPath}/Reportes?idlibro=${idlibro}">Reporte</a>
    <br><br><br><br>
    <hr>
    <br>
    ...
    <input type="button" value="..." class="boton" onclick="abrirVentana('${pageContext.servletContext.contextPath}/Prestamos?accion=listado_estados');">
