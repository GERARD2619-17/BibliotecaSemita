...
//imprime la tabla en pantalla
                ...
                request.getRequestDispatcher("prestamos/prestamos_consulta.jsp").forward(request, response);
            } catch (Exception ex) {
...
//imprime la tabla en pantalla
                ...
                request.setAttribute("tabla", tabla01);
                request.getRequestDispatcher("prestamos/libros_origen.jsp").forward(request, response);
            } catch (SQLException ex) {
            ...
            try {
                ...
                request.setAttribute("tabla", tabla01);
                request.getRequestDispatcher("prestamos/listado_libros.jsp").forward(request, response);
            } catch (Exception ex) {
                try {
                    Operaciones.rollback();
                } catch (SQLException ex1) {
            ...
            try {
                ...
                request.setAttribute("tabla", tabla01);
                request.getRequestDispatcher("prestamos/listado_estados.jsp").forward(request, response);
            } catch (Exception ex) {
                try {
                    Operaciones.rollback();
                } catch (SQLException ex1) {
            ...
            try {
                ...
                Operaciones.abrirConexion(conn);
                Operaciones.iniciarTransaccion();
                Prestamo p = Operaciones.eliminar(Integer.parseInt(request.getParameter("id")), new Prestamo());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/Prestamos?idlibro=" + idlibro + "&titulo=" + titulo);
        } catch (Exception ex) {
            try {
                Operaciones.rollback();
                out.println(ex.getMessage());
